...
namespace Stock.Api.Controllers
{
    ...
    public class ProviderController : ControllerBase
    {
        ...
        /// <summary>
        /// Lista los proveedores existentes 
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        ...
        /// <summary>
        /// Permite consultar un proveedor por su Id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpGet("{id}")]
        ...
        /// <summary>
        /// Permite realizar la busqueda por el nombre y/o el email
        /// </summary>
        /// <param name="model"></param>
        /// <returns>Devuelve una lista de proveedores que coinciden con los parametros de busqueda</returns>
        [HttpPost("search")]

...
class ProductTypesPage extends React.Component {
  ...
  onFilterSubmit = () => { this.props.fetchByFilters(this.state); };
...
const mapStateToProps = state => { return { productTypes: getProductTypes(state) }; };

const mapDispatchToProps = { getAll, push, fetchByFilters };

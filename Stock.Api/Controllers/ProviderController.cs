...
namespace Stock.Api.Controllers
{
    ...
    public class ProviderController : ControllerBase
    {
        ...
        /// <summary>
        /// Permite consultar un provider particular
        /// </summary>
        /// <param name="id">Identificador del provider a consultar</param>
        [HttpGet("{id}")]

...
namespace Stock.Api.Controllers
{
    ...
    public class ProviderController : ControllerBase
    {
      private ProviderService service;
        ...
        /// </summary>
        /// <param name="value">Una instancia de Provider</param>
        [HttpPost]
        ...
        /// <summary>
        /// Permite recuperar una instancia mediante un id
        /// </summary>
        /// <param name="id">Identificador de la instancia a recuperar</param>
        /// <returns>Una instancia de Provider</returns>
        [HttpGet("{id}")]
        ...
        /// <summary>
        /// Permite filtrar los proveedores por nombre o dirección de email
        /// </summary>
        /// <param name="model">Una instancia de ProviderSearch</param>
        [HttpPost("search")]

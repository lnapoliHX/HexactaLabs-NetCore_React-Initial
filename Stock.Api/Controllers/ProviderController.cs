...
namespace Stock.Api.Controllers
{
    ...
    public class ProviderController: ControllerBase
    {
        ...
        public ActionResult Post([FromBody] ProviderDTO value)
        {
            ...
            {
                return Ok(new { Success = false, Message = "El nombre de proveedor ya esta en uso." });
            }
        }
        ...
        /// <summary>
        /// Permite actualizar un Provider
        /// </summary>
        /// <param name="id"></param>
        /// <param name="value"></param>
        [HttpPut("{id}")]
        ...
        /// <summary>
        /// Permite borrar una instancia de Provider.
        /// </summary>
        ...
        /// <summary>
        /// Permite buscar un Provider por nombre o email
        /// </summary>
        ...
        public ActionResult Search([FromBody] ProviderSearchDTO model)
        {
            ...
            {
                filter = filter.AndOrCustom(
                    x => x.Name.ToUpper().Contains(model.Email.ToUpper()),
                    model.Condition.Equals(ActionDto.AND));
            }
